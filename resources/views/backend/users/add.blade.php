			                ...
			                <div class="card-body">
			                  	<div class="admin-input-outer">
				                    <div class="row">
				                      	<div class="col-sm-12">
					                        <div class="image-outer">
					                        	<img src="{{ asset('assets/images/avtar.png') }}" class="img-user1 user-img">
					                          	<input type="file" id="upload_profile" name="profile">
					                          	<img src="{{ asset('assets/images/camera.png') }}" class="camera-img">
					                        </div>
				                      	</div>
				                    </div>
				                      	...
				                      	<div class="col-sm-6">
					                        <div class="input-text-outer">
					                          	...
					                          	<select name="role" required>
						                             ...
						                             <option @if(old("type") == "superadmin") selected @endif value="superadmin">Superadmin</option>
				                    ...
				                    <div class="row">
				                      	<div class="col-sm-12">
					                        <div class="input-text-outer">
					                          	<button class="btn-admin" type="submit">Submit</button>
